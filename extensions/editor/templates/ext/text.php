		...
		<p>
			<textarea class="ExtraFieldData mceSelector" id="<?= $this->fieldID ?>" style="width: 100%; height: 500px"><?= str_replace ( array ( '<', '>' ), array ( '&lt;', '&gt;' ), encodeArenaHTML ( stripslashes ( $this->field->DataText ) ) ) ?></textarea>
		</p>
