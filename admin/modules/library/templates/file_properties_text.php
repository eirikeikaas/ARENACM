	...
	<textarea id="advfileContents" class="<?
		...
		return $classes;
	?> autocomplete-off" style="width: 100%; height: 340px; -moz-box-sizing: border-box; box-sizing: border-box;"><?= stripslashes ( trim ( $this->contents ) ? $this->contents : "// Tom fil" ) ?></textarea>
