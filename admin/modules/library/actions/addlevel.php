...
$level->grantPermission ( $Session->AdminUser, 'Read', '1', 'admin' );
$level->grantPermission ( $Session->AdminUser, 'Write', '1', 'admin' );
$level->grantPermission ( $Session->AdminUser, 'Publish', '1', 'admin' );
$level->grantPermission ( $Session->AdminUser, 'Structure', '1', 'admin' );
