...
<div class="ModuleContainer">
	<form method="post" name="newsform" enctype="multipart/form-data" action="admin.php?module=news&action=news">
		...
		<input type="hidden" name="IsEvent" value="0" />
			...
			<tr>
				...
				<td style="width: 35%">
					...
					<div id="TheNewsTabs">
								...
								<div class="SubContainer">
									<select name="CategoryID" style="width: 100%" size="10">
										<?
											...
											if ( !$cat->Language ) $cat->Language = $GLOBALS[ "Session" ]->CurrentLanguage;
						...
						<div class="page" id="pageNewsBiblotek">
