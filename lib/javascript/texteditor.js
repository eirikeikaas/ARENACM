...
function insertLink ( )
{
	...
	document.getElementById ( 'LinkEditDone' ).onclick = function ( )
	{
		...
		if ( document.getElementById ( 'link__Url' ).value.length < 1 && document.getElementById ( 'link__Arena' ).value.length < 1 && document.getElementById ( 'link__Email' ).value.length < 1 )
		{
