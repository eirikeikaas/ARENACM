...
texteditor.addControl = function ( area )
{
	...
	obj.GenerateToolbar ( Array ( 
		...
		adv ? { 'type' : 'button', 'classname' : 'bVimeo', 'action' : 'insertVimeo ( )', 'title' : 'Sett inn Vimeo link', 'icon' : 'vimeo_add.png' } : {},
	...
	obj.insertVimeo = function ()
	{
		...
		if ( lnk && lnk.length )
		{
			if ( lnk.indexOf ( 'vimeo.com/' ) > 0 )
			{
				...
				d.getTime() + '" data="' + lnk + '" width="480" height="270" wmode="transparent" type="application/x-shockwave-flash">' +
				'	<param name="allowfullscreen" value="true"></param>' +
				'	<param name="allowscriptaccess" value="always"></param>' +
				'	<param name="width" value="480"></param>' +
				'	<param name="height" value="270"></param>' +
