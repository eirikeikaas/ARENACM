...
texteditor.addControl = function ( area )
{
	...
	obj.GenerateToolbar ( Array ( 
		...
		{ 'type' : 'spacer' },
		adv ? { 'type' : 'button', 'classname' : 'bFlash', 'action' : 'insertFlash ( )', 'title' : 'Sett inn flash film', 'icon' : 'film.png' } : {},
		this.mode == 'admin' ? { 'type' : 'button', 'classname' : 'bImage', 'action' : 'insertImage ( )', 'title' : 'Sett inn bilde', 'icon' : 'image.png' } : {},
		adv ? { 'type' : 'button', 'classname' : 'bTable', 'action' : 'insertTable ( )', 'title' : 'Sett inn tabell', 'icon' : 'table.png' } : {},
